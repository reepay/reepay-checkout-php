...
class Order implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'billing_address' => '\Swagger\Client\Model\InvoiceBillingAddress',
        'shipping_address' => '\Swagger\Client\Model\InvoiceShippingAddress'
    ];
    ...
    public function setAmount($amount)
    {
        ...
        if (!is_null($amount) && ($amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling Order., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \Swagger\Client\Model\InvoiceBillingAddress
     */
     ...
     *
     * @param \Swagger\Client\Model\InvoiceBillingAddress $billing_address Optional billing address
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\InvoiceShippingAddress
     */
     ...
     *
     * @param \Swagger\Client\Model\InvoiceShippingAddress $shipping_address Optional shipping address
     *
     * @return $this
     */
