...
class PreparedSubscription implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['renewal_count'] < 0)) {
            $invalidProperties[] = "invalid value for 'renewal_count', must be bigger than or equal to 0.";
        }
     ...
     * Sets invoices
     *
     * @param \Swagger\Client\Model\Invoice[] $invoices List of created (prepared) invoices for prepared subscription
     *
     * @return $this
     */
    ...
    public function setRenewalCount($renewal_count)
    {
        ...
        if (($renewal_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $renewal_count when calling PreparedSubscription., must be bigger than or equal to 0.');
        }
