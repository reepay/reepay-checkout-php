...
class CreatePreparedSubscription implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['plan_version']) && ($this->container['plan_version'] < 1)) {
            $invalidProperties[] = "invalid value for 'plan_version', must be bigger than or equal to 1.";
        }
    ...
    public function setPlanVersion($plan_version)
    {
        ...
        if (!is_null($plan_version) && ($plan_version < 1)) {
            throw new \InvalidArgumentException('invalid value for $plan_version when calling CreatePreparedSubscription., must be bigger than or equal to 1.');
        }
    ...
    public function setGraceDuration($grace_duration)
    {
        ...
        if (!is_null($grace_duration) && ($grace_duration < 0)) {
            throw new \InvalidArgumentException('invalid value for $grace_duration when calling CreatePreparedSubscription., must be bigger than or equal to 0.');
        }
