...
class Account implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['default_vat'] > 1)) {
            $invalidProperties[] = "invalid value for 'default_vat', must be smaller than or equal to 1.";
        }

        if (($this->container['default_vat'] < 0)) {
            $invalidProperties[] = "invalid value for 'default_vat', must be bigger than or equal to 0.";
        }
