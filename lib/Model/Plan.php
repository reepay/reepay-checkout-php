...
class Plan implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['renewal_reminder_email_days']) && ($this->container['renewal_reminder_email_days'] < 1)) {
            $invalidProperties[] = "invalid value for 'renewal_reminder_email_days', must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['trial_reminder_email_days']) && ($this->container['trial_reminder_email_days'] < 1)) {
            $invalidProperties[] = "invalid value for 'trial_reminder_email_days', must be bigger than or equal to 1.";
        }
        ...
        if (!is_null($this->container['setup_fee']) && ($this->container['setup_fee'] < 0)) {
            $invalidProperties[] = "invalid value for 'setup_fee', must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['fixed_life_time_length']) && ($this->container['fixed_life_time_length'] < 1)) {
            $invalidProperties[] = "invalid value for 'fixed_life_time_length', must be bigger than or equal to 1.";
        }
        ...
        if (!is_null($this->container['trial_interval_length']) && ($this->container['trial_interval_length'] < 1)) {
            $invalidProperties[] = "invalid value for 'trial_interval_length', must be bigger than or equal to 1.";
        }
        ...
        if (($this->container['interval_length'] < 1)) {
            $invalidProperties[] = "invalid value for 'interval_length', must be bigger than or equal to 1.";
        }
        ...
        if (!is_null($this->container['schedule_fixed_day']) && ($this->container['schedule_fixed_day'] > 28)) {
            $invalidProperties[] = "invalid value for 'schedule_fixed_day', must be smaller than or equal to 28.";
        }

        if (!is_null($this->container['schedule_fixed_day']) && ($this->container['schedule_fixed_day'] < 1)) {
            $invalidProperties[] = "invalid value for 'schedule_fixed_day', must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['base_month']) && ($this->container['base_month'] > 12)) {
            $invalidProperties[] = "invalid value for 'base_month', must be smaller than or equal to 12.";
        }

        if (!is_null($this->container['base_month']) && ($this->container['base_month'] < 1)) {
            $invalidProperties[] = "invalid value for 'base_month', must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['notice_periods']) && ($this->container['notice_periods'] < 0)) {
            $invalidProperties[] = "invalid value for 'notice_periods', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['fixation_periods']) && ($this->container['fixation_periods'] < 0)) {
            $invalidProperties[] = "invalid value for 'fixation_periods', must be bigger than or equal to 0.";
        }
